import{_ as l,M as d,p as t,q as r,R as e,t as n,N as a,a1 as i}from"./framework-603319ee.js";const c={},o=i('<h1 id="the-beginning-of-collaboration" tabindex="-1"><a class="header-anchor" href="#the-beginning-of-collaboration" aria-hidden="true">#</a> The Beginning of Collaboration</h1><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>좋은 팀은 좋은 제품을 만든다 - 선릉역호랭이들의 일하는 방식</p></div><h3 id="step-1-kanban" tabindex="-1"><a class="header-anchor" href="#step-1-kanban" aria-hidden="true">#</a> STEP 1 - kanban</h3>',3),u={class:"custom-container details"},v=i(`<summary>매일 매일 서로 도움을 주고 받기 - Daily Meeting</summary><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>- 칸반 미팅 통해여 서로의 작업 공유 - 09:15
- 서로 도와 재밋고 효율적 방법 찾기
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),m=e("li",null,[e("ol",null,[e("li",null,"어떤 일을 끝마쳤는지")])],-1),h=e("li",null,[e("ol",{start:"2"},[e("li",null,"어떤 일을 진행할 예정인지")])],-1),b={start:"3"},p={href:"https://kanban.university/kanban-guide/#download",target:"_blank",rel:"noopener noreferrer"},g=e("img",{src:"https://i0.wp.com/congruentagile.com/wp-content/uploads/2021/11/칸반-만화.png?resize=1024%2C777&ssl=1",alt:"ygwg"},null,-1),_=i(`<h3 id="step-2-create-branch" tabindex="-1"><a class="header-anchor" href="#step-2-create-branch" aria-hidden="true">#</a> STEP 2 - create branch</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token builtin class-name">pwd</span>
...
　.|　　|
　 U⌒U.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="step-6-code-review" tabindex="-1"><a class="header-anchor" href="#step-6-code-review" aria-hidden="true">#</a> STEP 6 - code review</h3>`,9),w={class:"custom-container details"},f=e("summary",null,"개발자가 마스터가 되어가는 긴 여정",-1),k={href:"http://guruble.com/%EC%86%8C%ED%94%84%ED%8A%B8%EC%9B%A8%EC%96%B4-%EC%9E%A5%EC%9D%B8%EC%A0%95%EC%8B%A0software-craftsmanship/",target:"_blank",rel:"noopener noreferrer"},x=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>애자일 선언문 (Agile Manifesto)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),T=i(`<h3 id="step-7-deploy-stg-uat" tabindex="-1"><a class="header-anchor" href="#step-7-deploy-stg-uat" aria-hidden="true">#</a> STEP 7 - deploy STG &amp; UAT</h3><details class="custom-container details"><summary>User Acceptance Testing . 사용자 수락 테스트</summary><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Agile Team Tiger@cashmallow 는
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="step-8-deploy-prd" tabindex="-1"><a class="header-anchor" href="#step-8-deploy-prd" aria-hidden="true">#</a> STEP 8 - deploy PRD</h3>`,3),E={class:"custom-container details"},C=e("summary",null,"팀은 새 기능을 적기에 출시하고 사용자에게 신뢰성을 보장",-1),y={href:"https://www.redhat.com/ko/topics/devops/what-is-sre",target:"_blank",rel:"noopener noreferrer"},P=e("li",null,"SRE 팀은 소프트웨어를 툴로 활용하여",-1),S=e("li",null,"시스템을 관리하고,",-1),R=e("li",null,"문제를 해결하고,",-1),A=e("li",null,"운영 태스크를 자동화",-1),$=i(`<hr><ul><li>SRE를 활용하는 팀은 새 기능을 적기에 출시하고 사용자에게 신뢰성을 보장</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.　 　 ∩　 ∩
　　 / |／ /
　　/ 　　/
⊂二 　 　 二⊃
　（ ､σ， ）&amp; SRE～
　　Ｖ&quot;Ｖ
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),B=e("h3",{id:"step-9-애자일-회고",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#step-9-애자일-회고","aria-hidden":"true"},"#"),n(" STEP 9 - 애자일 회고")],-1),q={class:"custom-container details"},U=e("summary",null,"업무를 민주적이고 객관적 시작으로 돌아보기",-1),I={href:"https://brunch.co.kr/@sweetsavasana/40",target:"_blank",rel:"noopener noreferrer"},D=e("img",{src:"https://i0.wp.com/congruentagile.com/wp-content/uploads/2019/10/122_3.jpeg?fit=800%2C326&ssl=1",alt:"Aglie Big Thing"},null,-1),L=e("li",null,"팀이 정기적으로 만나 이터레이션 기간 동안 무슨 일이 있었는지,",-1),N=e("li",null,"그리고 자신들이 일하는 방식은 어떠한지 돌아보고",-1),V=e("li",null,"무엇을 개선하면 좋을지 논의하는 자리",-1);function M(G,j){const s=d("ExternalLinkIcon");return t(),r("div",null,[o,e("details",u,[v,e("ul",null,[m,h,e("li",null,[e("ol",b,[e("li",null,[n("그리고 업무에 지장을 줄 수 있는 요소가 무엇이고 - 힐러와 히어로를 찾기 "),e("a",p,[n("kanban-guide"),a(s)]),g])])])])]),_,e("details",w,[f,e("ul",null,[e("li",null,[e("a",k,[n("소프트웨어 장인정신"),a(s)])])]),x]),T,e("details",E,[C,e("ul",null,[e("li",null,[e("a",y,[n("SRE(사이트 신뢰성 엔지니어링)란?"),a(s)])]),P,S,R,A]),$]),B,e("details",q,[U,e("ul",null,[e("li",null,[e("a",I,[n("회고 진행 방식"),a(s)]),D]),L,N,V])])])}const H=l(c,[["render",M],["__file","index.html.vue"]]);export{H as default};
